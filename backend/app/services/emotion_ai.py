...
class EmotionAnalyzer:
    ...
    def analyze(self, text: str):
        ...
        if "bored" in text_lower or "nothing to do" in text_lower or "dull" in text_lower or "mid" in text_lower or "meh" in text_lower:
            emotion = "boredom"
            mood = "low_energy"
            ...
            mood = "low_energy"
            score = max(score, 0.9)
        elif "anxious" in text_lower or "worried" in text_lower or "nervous" in text_lower or "stress" in text_lower:
            emotion = "fear"
            mood = "anxious"
             ...
             mood = "stressed"
             score = max(score, 0.85)
        elif "done with life" in text_lower or "can't take it" in text_lower or "give up" in text_lower or "suicid" in text_lower or "end it" in text_lower:
             emotion = "sadness"
             mood = "sad"
             score = 0.99

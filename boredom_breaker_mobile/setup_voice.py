...
FILE_PATH = "/Users/joeltharakan/Documents/AI Boredom System/boredom_breaker_mobile/lib/screens/voice/voice_mode_screen.dart"
...
import '../home/main_layout.dart'; // Just in case
...
class _VoiceModeScreenState extends State<VoiceModeScreen>
  ...
  Future<void> _processVoiceCommand(String transcript) async {
    ...
    try {
      ...
      final userId = session?['user_id']?.toString() ?? '1';
      ...
      setState(() {
        _lunoReply = "Sorry, I had trouble understanding that. Could you repeat?";
      });
          ...
          Center(
            child: Column(
              ...
              children: [
                      ...
                      return Stack(
                        ...
                        children: [
                          if (_isListening || _isProcessing) ...[
                            _MicAura(scale: scale * 1.5, opacity: opacity * 0.5),
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              boxShadow: [
                                if (_isListening || _isProcessing)
                                  BoxShadow(
                                    color: (_isProcessing ? Colors.purple : AppColors.primary).withValues(alpha: 0.4),
                                    blurRadius: 40,
                                    spreadRadius: 10,
                                  ),
                              ],
                            ...
                            child: Icon(
                              _isProcessing ? Icons.auto_awesome : (_isListening ? Icons.mic_rounded : Icons.mic_off_rounded),
                              size: 60,
                              color: Colors.white,
                            ),
                          ),
                ...
                Text(
                      _isProcessing ? "Thinking..." : _isListening ? "Listening..." : "Tap to Speak",
                      style: GoogleFonts.outfit(
                        fontSize: 28,
                        fontWeight: FontWeight.bold,
                        color: Colors.white,
                      ),
                    ).animate(target: (_isListening || _isProcessing) ? 1 : 0).shimmer(duration: 2.seconds),

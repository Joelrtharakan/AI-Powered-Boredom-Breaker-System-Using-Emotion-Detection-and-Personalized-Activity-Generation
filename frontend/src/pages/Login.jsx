...
export default function Login() {
    ...
    return (
        <div className="flex min-h-screen bg-background text-txt-main overflow-x-hidden relative selection:bg-primary/20 flex-col lg:flex-row">
            ...
            <div className="hidden lg:flex w-full lg:w-1/2 relative items-center justify-center p-12 overflow-hidden min-h-[300px] lg:min-h-screen">
                ...
                <div className="relative z-10 max-w-lg space-y-8">
                    <motion.h1
                        ...
                        className="text-7xl font-bold tracking-tighter leading-tight text-white"
                    >
                        Escaping<br />
                        The<br />
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8 relative">
                ...
                >
                    <div className="space-y-2">
                        ...
                        <h2 className="text-3xl font-bold tracking-tight text-white">{isResetting ? "Reset Password" : "Welcome back"}</h2>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        >
                            ...
                            <div className={`relative transition-all duration-300 rounded-xl bg-white/5 border ${focusedField === 'email' ? 'border-primary ring-1 ring-primary/20' : 'border-white/10'}`}>
                                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                    <Mail className={`h-5 w-5 transition-colors ${focusedField === 'email' ? 'text-primary' : 'text-zinc-500'}`} />
                                </div>
                                <input
                                    type="email"
                                    className="block w-full pl-11 pr-4 py-4 bg-transparent text-white placeholder-zinc-600 focus:outline-none rounded-xl"
                        ...
                        >
                            ...
                            <div className={`relative transition-all duration-300 rounded-xl bg-white/5 border ${focusedField === 'password' ? 'border-primary ring-1 ring-primary/20' : 'border-white/10'}`}>
                                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                    <Lock className={`h-5 w-5 transition-colors ${focusedField === 'password' ? 'text-primary' : 'text-zinc-500'}`} />
                                </div>
                                <input
                                    type="password"
                                    className="block w-full pl-11 pr-4 py-4 bg-transparent text-white placeholder-zinc-600 focus:outline-none rounded-xl"

                    ...
                    <div className="p-8 md:p-12 flex flex-col items-center text-center gap-8">
                        ...
                        <div className="w-full max-w-3xl relative group">
                            <textarea
                                ...
                                className="w-full bg-surface/50 border border-white/10 rounded-3xl p-6 md:p-8 text-xl md:text-2xl text-txt-main placeholder-txt-dim focus:outline-none focus:border-primary/50 transition-all resize-none shadow-inner min-h-[160px]"
                            />
                            <div className="absolute bottom-6 right-6 flex gap-3">
                                <button className="p-3 rounded-full bg-white/5 hover:bg-white/10 text-txt-muted hover:text-white transition-all hover:scale-110">
                                    <Mic size={24} />
                                </button>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-wrap gap-4 justify-center w-full">
                            ...
                            <button
                                ...
                                className="px-8 py-4 rounded-xl border border-white/10 hover:bg-white/5 text-txt-muted font-medium transition-colors bg-gradient-to-tr from-yellow-400/10 to-orange-500/10 hover:text-white"
                            >
                                Surprise Me 🎁
                            </button>
                        </div>
                        ...
                        <div className="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
                            <div>
                                ...
                                <div className="text-3xl md:text-4xl font-bold text-txt-main capitalize flex items-center gap-3">
                                    {suggestion.mood} <span className="text-lg font-normal text-txt-muted bg-white/5 px-3 py-1 rounded-full">{Math.round((suggestion.intensity || 0) * 100)}% Intensity</span>
                                </div>
                            </div>
                            ...
                            {suggestion.plan && suggestion.plan.length > 0 ? (
                                suggestion.plan.map((item, i) => (
                                    <motion.div
                                        ...
                                        className={`bg-white/5 border border-white/5 shadow-lg p-6 rounded-2xl hover:bg-white/10 transition-colors flex flex-col gap-3 group ${['breathing', 'game', 'music'].includes(item.type) ? 'cursor-pointer hover:border-primary/50 ring-1 ring-transparent hover:ring-primary/30' : ''
                                            }`}
                                    >
                    ...
                    {showModal && (
                        ...
                        >
                            <motion.div
                                ...
                                className="bg-[#09090b] border border-white/10 p-8 rounded-3xl max-w-md w-full shadow-2xl relative overflow-hidden"
